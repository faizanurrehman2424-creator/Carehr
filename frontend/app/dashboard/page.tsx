                                             ...
                                             <div key={group.id} className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                                                 ...
                                                 <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                                                     {group.items.map(item => {
                                                         ...
                                                         return (
                                                             <div key={item.id} className={`flex flex-col justify-between p-4 rounded-xl border transition-all ${isPresent ? 'bg-gray-50/50 dark:bg-gray-800/30 border-gray-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-700' : 'bg-red-50/30 dark:bg-red-900/5 border-red-100 dark:border-red-900/30 border-dashed'}`}>
                                                                 <div className="flex items-start gap-4 mb-4">
                                                                     <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${isPresent ? 'bg-teal-50 text-teal-600 dark:bg-teal-900/30 dark:text-teal-400' : 'bg-red-100 text-red-500 dark:bg-red-900/30 dark:text-red-400'}`}>
                                                                         {isPresent ? (
                                                                     ...
                                                                     <div>
                                                                         <div className={`text-sm font-bold ${isPresent ? 'text-gray-900 dark:text-gray-100' : 'text-red-700 dark:text-red-400'}`}>
                                                                             {item.label}
                                                                         </div>
                                                                         <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">
                                                                            {isPresent ? 'Verified & Stored' : 'Awaiting Upload'}
                                                                         </div>
                                                                     </div>
                                                                 </div>
                                                                 ...
                                                                 <div className="mt-auto">
                                                                     {isPresent && docMatch?.view_link ? (
                                                                         <a 
                                                                            ...
                                                                            className="block w-full text-center text-xs font-bold text-teal-700 bg-white hover:bg-teal-50 dark:text-teal-300 dark:bg-gray-800 dark:hover:bg-teal-900/30 py-2 rounded-lg transition-colors border border-gray-200 dark:border-gray-700"
                                                                         >
                                                                             OPEN DOCUMENT
                                                                         </a>
                                                                     ) : !isPresent ? (
